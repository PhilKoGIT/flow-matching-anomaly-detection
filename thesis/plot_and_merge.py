...
SHOW_ONLY_MODELS = [
    ...
    #for the sensitivity analysis: Uncomment a block to show only these models in the plots; comment the others out
    #-> and set colors accordingly in COLORS_MODELS!
...
def get_all_models(merged):
    """Finds all models (filtered if SHOW_ONLY_MODELS is set)."""
    models = set()
...
def create_compact_pdfs(merged, output_dir):
    """Creates compact PDFs with all plots."""
...
if __name__ == "__main__":
    ...
    # =========================================================================
    # How to use:
    # 1. Set result_files to the list of result files to merge (already existent on the usb stick)
    # 2. Set models to show through setting SHOW_ONLY_MODELS and COLORS_MODELS at the top
    # 3. Run the script
    # =========================================================================
    result_files = [
        #for campaign set experiments
        Path("./results_diff/results.joblib"),
        Path("./results_flow/results.joblib"),
        Path("./results_tccm/results.joblib"),
 
        #only for the business dataset experiment -> uncomment to include and comment the others above!
        #Path("./results_business_study/results.joblib"),
