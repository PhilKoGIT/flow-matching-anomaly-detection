...
# ============================================================
    ...
    df_train_y1 = df_train[df_train["target"] == 1]

    df_test_augmented = pd.concat([df_test, df_train_y1], ignore_index=True)
...
# ============================================================
    ...
    int_indexes = list(range(n_features))  # alle Spalten numerisch
    int_indexes.remove(3)  
    ...
    print("✅ Modell gespeichert unter forest_diffusion_model.joblib")
