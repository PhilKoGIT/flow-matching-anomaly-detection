...
#-------------------------------------  
#copied from https://github.com/andresguzco/ef-vfm/blob/main/utils_train.py

#src also copied from Eff-VFM repo!
#-------------------------------------
...
def preprocess(dataset_path, dequant_dist='none', int_dequant_factor=0.0, task_type = 'binclass', inverse = False, cat_encoding = None, concat = True):
    ...
    if cat_encoding is None:
        ...
        if X_cat is not None:
            ...
            # Setze X_cat auf leere Numpy-Arrays, wenn keine kategorialen Daten vorhanden sind
